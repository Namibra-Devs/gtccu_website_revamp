                  ...
                  >
                    ...
                    >
                      ...
                      {isCenter && (
                        ...
                        >
                          <div className="bg-gradient-to-r from-blue-600 to-blue-900 text-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-full shadow-lg flex items-center gap-2">
                            <Star size={12} className="text-[#1A1C47]" />
